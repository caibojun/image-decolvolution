...
#               print "----------------------------------------\n"
                ...
                s1=time.clock()
                Mesh(Save,fit,mesh,gray,h,w)
                e1=time.clock()
                print "Single picture spends: %f seconds"%(e1-s1)

def Mesh(Save,fit,window,gray,h,w):
        ...
        while mesh_h<=h:
                ...
                mesh_h+=mesh
        img = bwlabel(gray)
        pickout(Save,fit,img,copy)


def pickout(Save,fit,mat,orimat):
        ...
        for i in range(1,num+1):
                ...
                if count>=2:#delete regions too small to extract PSFs
                        ...
                        pickoutv1(Save,fit,obj,orimat,f)

def pickoutv1(Save,fit,mat,orimat,f):
        star = bwlabel(mat)
        labels=1
        xval=0
        yval=0
